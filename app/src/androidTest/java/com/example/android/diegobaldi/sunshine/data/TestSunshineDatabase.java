 ...
 */
package com.example.android.diegobaldi.sunshine.data;
...
public class TestSunshineDatabase {
     ...
     */
    private static final String packageName = "com.example.android.diegobaldi.sunshine";
    ...
    public void before() {
        try {
            ...
            REFLECTED_TABLE_NAME = TestUtilities.getStaticStringField(weatherEntryClass, tableNameVariableName);
            REFLECTED_COLUMN_DATE = TestUtilities.getStaticStringField(weatherEntryClass, columnDateVariableName);
            REFLECTED_COLUMN_WEATHER_ID = TestUtilities.getStaticStringField(weatherEntryClass, columnWeatherIdVariableName);
            REFLECTED_COLUMN_MIN = TestUtilities.getStaticStringField(weatherEntryClass, columnMinVariableName);
            REFLECTED_COLUMN_MAX = TestUtilities.getStaticStringField(weatherEntryClass, columnMaxVariableName);
            REFLECTED_COLUMN_HUMIDITY = TestUtilities.getStaticStringField(weatherEntryClass, columnHumidityVariableName);
            REFLECTED_COLUMN_PRESSURE = TestUtilities.getStaticStringField(weatherEntryClass, columnPressureVariableName);
            REFLECTED_COLUMN_WIND_SPEED = TestUtilities.getStaticStringField(weatherEntryClass, columnWindSpeedVariableName);
            REFLECTED_COLUMN_WIND_DIR = TestUtilities.getStaticStringField(weatherEntryClass, columnWindDirVariableName);
            ...
            fail(TestUtilities.studentReadableClassNotFound(e));
...
>>>>>>> 4174cf2... S07.02-Exercise-PreventInvalidInserts
     ...
     * <p>
     * {@link com.example.android.diegobaldi.sunshine.data.WeatherContract.WeatherEntry#TABLE_NAME}.
     * <p>
